...
COMMAND_DESCRIPTIONS = {
    ...
    "announcefeed add": "Add an RSS, Atom, JSON, Fediverse profile, or X/RSSHub announcement feed.",
    ...
    "music play": "Queue and play a song URL, Spotify track URL, or searchable query.",
    "music playlist": "Queue up to 25 tracks from a playlist, album, or supported URL.",
...
PARAMETER_DESCRIPTIONS = {
    ...
    "feed_url": "RSS/Atom/JSON feed, Fediverse profile, or X profile URL.",
    "name": "Display name for this item.",
    "song_url": "Song URL, Spotify track URL, or searchable query.",
    "playlist_url": "Playlist or album URL.",
