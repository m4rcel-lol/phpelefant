...
COMMAND_DESCRIPTIONS = {
    ...
    "join": "Join your current voice or stage channel.",
    "play": "Queue and play a song URL or searchable query.",
    "playlist": "Queue up to 25 tracks from a playlist URL.",
    "pause": "Pause the current song.",
    "resume": "Resume paused playback.",
    "stop": "Stop playback and clear the music queue.",
    "loop": "Toggle or set current-track looping.",
    "nowplaying": "Show the currently playing track.",
    "leave": "Disconnect PHPelefant from voice.",
